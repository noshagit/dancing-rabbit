...
func PetitBacMenuHandler(router *mux.Router) {
	router.HandleFunc("/petit-bac/petit-bac-menu.html", func(w http.ResponseWriter, r *http.Request) {
		http.ServeFile(w, r, "../../frontend/petit-bac/petit-bac-menu.html")
	}).Methods("GET")
