...
var (
	petitBacTmpl *template.Template
	...
	playerVotes = make(map[string]map[string]map[string]bool)
...
func game(w http.ResponseWriter, r *http.Request) {
	...
	petitBacTmpl.ExecuteTemplate(w, "petit-bac.html", data)
}
...
func vote(w http.ResponseWriter, r *http.Request) {
	...
	clientsMutex.Unlock()
	petitBacTmpl.ExecuteTemplate(w, "vote.html", nil)
}
...
func scoreboard(w http.ResponseWriter, r *http.Request) {
	...
	petitBacTmpl.ExecuteTemplate(w, "scoreboard.html", finalScores)
}
...
func timerEnd() {
	...
	if petitBacCurrentRound >= maxRounds {
		endPetitBacGame()
		return
	}
	broadcastMessage(Message{
